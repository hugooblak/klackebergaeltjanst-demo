<?php
/**
 * Kläckeberga Eltjänst AB theme functions.
 *
 * Kept short on purpose. Design lives in theme.json, markup in templates and patterns.
 * Lead capture lives in the "Kläckeberga Eltjänst AB Leads" plugin, so leads survive a theme change.
 *
 ...
 * Patterns read these through kl_lead() so one demo can be rebuilt for any firm.
 */
...
add_action(
	'wp_enqueue_scripts',
	function () {
		wp_enqueue_style( 'klackebergaeltjanst', get_stylesheet_uri(), array(), wp_get_theme()->get( 'Version' ) );
	}
);
add_action(
	'after_setup_theme',
...
add_action(
	'init',
	function () {
		register_block_style( 'core/paragraph', array( 'name' => 'eyebrow', 'label' => __( 'Eyebrow label', 'klackebergaeltjanst' ) ) );
		register_block_style( 'core/list', array( 'name' => 'checklist', 'label' => __( 'Tick list', 'klackebergaeltjanst' ) ) );

		register_block_pattern_category( 'klackebergaeltjanst-sections', array( 'label' => __( 'Kläckeberga Eltjänst AB sections', 'klackebergaeltjanst' ) ) );
		register_block_pattern_category( 'klackebergaeltjanst-pages', array( 'label' => __( 'Kläckeberga Eltjänst AB page layouts', 'klackebergaeltjanst' ) ) );
	}
);
