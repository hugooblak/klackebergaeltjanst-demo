...
/**
 * Title: Not found
 * Slug: klackebergaeltjanst/not-found
...
<div class="wp-block-button kl-track-cta"><a class="wp-block-button__link wp-element-button" href="<?php echo $url( '/free-quote/' ); ?>">Boka besiktning</a></div>
<!-- /wp:button -->
