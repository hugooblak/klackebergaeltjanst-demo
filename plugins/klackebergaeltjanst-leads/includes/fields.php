...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'klackebergaeltjanst-leads' ),
				'storm'       => __( 'Storm or hail damage', 'klackebergaeltjanst-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'klackebergaeltjanst-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'klackebergaeltjanst-leads' ),
				'not-sure'    => __( 'Vet inte än', 'klackebergaeltjanst-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'klackebergaeltjanst-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'klackebergaeltjanst-leads' ),
				'research' => __( 'Jag kollar bara priser', 'klackebergaeltjanst-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'klackebergaeltjanst-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'klackebergaeltjanst-leads' ),
		'contacted' => __( 'Kontaktad', 'klackebergaeltjanst-leads' ),
		'quoted'    => __( 'Quote sent', 'klackebergaeltjanst-leads' ),
		'won'       => __( 'Won', 'klackebergaeltjanst-leads' ),
		'lost'      => __( 'Lost', 'klackebergaeltjanst-leads' ),
		'spam'      => __( 'Misstänkt spam', 'klackebergaeltjanst-leads' ),
	);
}
